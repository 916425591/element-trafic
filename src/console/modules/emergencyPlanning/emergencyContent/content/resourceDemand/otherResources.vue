...
export default {
  ...
  data () {
    ...
    return {
              ...
              h('Poptip', {
                ...
                on: {
                  'on-ok': () => {
                    ...
                    vm.deleteOtherResources(params)
                  }
                }
              }, [
                h('Button', {
      ...
      ruleCustom: {
        ...
        unitId: [
          { required: true, validator: validateUnitName, trigger: 'change' }
        ],
        counts: [
          { required: true, type: 'number',validator: validateCounts, trigger: 'blur' }
        ],
        functions: [
  ...
  methods: {
    ...
    otherQuery () {
      ...
      axios({
          method: 'post',
          url: this.url + '/plan/content/queryPlanContent4ResOtherByPage',
          data: info
      }).then(
          response => {
