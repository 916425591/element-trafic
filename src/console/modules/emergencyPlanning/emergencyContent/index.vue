    ...
    <Row>
      <i-col span="5">
        <div class="ds-widget-box" :data-json="tableHeight">
          ...
          <div class="plan_content_group_btn"> 
            <Button type="ghost" size="small" @click="addNodes" style="background: #fff;">
              <Icon type="android-add" size="20"></Icon>
            </Button>
            <Button :disabled="status" type="ghost" size="small" @click="editNodesInfo" style="background: #fff;">
              <Icon type="edit" size="20"></Icon>
            </Button>
            <Button type="ghost" size="small" @click="setNodesInfo" style="background: #fff;">
              <Icon type="gear-b"></Icon>
            </Button>
            <Poptip confirm title="您确认删除这条内容吗？" @on-ok="deleteNodes" placement="bottom-end">
              <Button :disabled="status" type="ghost" size="small" style="background: #fff;">
                <Icon type="trash-a"></Icon>
              </Button>
            </Poptip>
          </div>
          <div class="ds-tree-left ds-resources-listBox" :style='height'>
      ...
      <i-col span="19">
        <div v-if="contentStatus === 0">
          <div :style='height2'>
            <div style="width: 100%;text-align:center;padding-top:100px;font-size:26px;">请选择左侧内容节点，设置预案内容信息</div>
          </div>
        </div>
...
import preliminaryDisposalScheme from './content/preliminaryDisposalScheme/preliminaryDisposalScheme'
import headQuarters from './content/headQuarters/view/headQuarters'
import fontHeadQuarters from './content/headQuarters/view/fontHeadQuarters'
import sceneHeadQuarters from './content/headQuarters/view/sceneHeadQuarters'
import fenHeadQuarters from './content/headQuarters/view/fenHeadQuarters'
import memberOrg from './content/memberOrg/view/memberOrg'
import expertGroup from './content/expertGroup/view/expertGroup'
import securityGroup from './content/securityGroup/view/securityGroup'
import orgAnization from './content/orgAnization/view/orgAnization'
import fourColorEarlyWarning from './content/fourColorEarlyWarning/fourColorEarlyWarning'
import perplanTextInfo from './content/perplanTextInfo/perplanTextInfo'
import gradedResponse from './content/gradedResponse/gradedResponse'
/**资源 */
import resourcesReady from './content/resourcesReady/resourcesReady'
import otherResources from './content/resourceDemand/otherResources'
import disposalTeam from './content/resourceDemand/disposalTeam'
import equipmentEstimation from './content/resourceDemand/equipmentEstimation'
import materialEstimation from './content/resourceDemand/materialEstimation'
import professionalVehicles from './content/resourceDemand/professionalVehicles'
/*避险场所*/
import safeHaven from './content/safeHaven/safeHaven'
...
export default {
  ...
  computed: {
    ...
    tableHeight() {
      ...
      this.height.height = parseInt(height)-115 + 'px' /*定义好的父框体高度*/
  ...
  methods: {
    ...mapActions([
      ...
      'setQuarteryType',
      'savePlanContentId'//保存预案内容treeid
    ]),
    deleteNodes() {
    ...
    getTreeAboutContent() {
      const url = this.url + '/plan/planContentNode/findPlanContentNodes'
      const params = {
        userCode: this.userCode,
        planId: this.planIdInfo,
        name: this.nodeName
