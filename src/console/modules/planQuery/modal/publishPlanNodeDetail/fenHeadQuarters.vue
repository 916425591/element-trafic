    ...
    <div>
        <div class="ds-widget-box ds-box">
            <div class="ds-widget-title">
                ...
                <h2 :data-id='quartersType'>分指挥中心</h2>
            </div>
            <div style="height: 305px; overflow-y: scroll;">
                        ...
                        <table class="ds-quarter-table">
                            ...
                            <tr>
                                ...
                                <!-- <td class="ds-quarter-btn">
                                     <Button type="primary" @click="saveDuty(leader.id)">保存</Button>
                    ...
                    <i-col span="21">
                        <table class="ds-quarter-table">
                            ...
                            <tr>
                                ...
                                <!-- <td class="ds-quarter-btn">
                                     <Button type="primary" @click="saveDuty(item.id, item.function)">保存</Button>
                ...
                <Row v-if="this.headQuartersList.length===0">
                    <i-col span="3" class="ds-expert-head">
                        <div >
                            <Icon class="ds-bg-icon" type="person"></Icon>
                            <p>副指挥</p>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getAllHeadQuarters() {
                const url = this.url + '/plan/headquarters/findFBHeadquarters2Map'
                const userCode = this.userCode
                axios({
                    method: 'get',
                    url: url,
