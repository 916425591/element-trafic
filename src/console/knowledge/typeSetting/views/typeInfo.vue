        ...
        methods: {
            ...
            alertTree() {
                let TreeInfo = {
                    ...
                    url: this.url('/platform/public/queryKnowledgeTree4New')
                }
            ...
            change_save () {
                ...
                axios({
                    method: 'post',
                    url: this.url('/platform/knowledgeType/saveKnowledgeType'),
                    data: resTypeInfo
                }).then(
                    response => {
            ...
            delete_equipment () {
                ...
                axios({
                    method: 'get',
                    url: this.url('/platform/knowledgeType/removeKnowledgeType'),
