        ...
        <div class="ds-widget-title">
            ...
            <Row class="ds-fload-right">
                <i-col span="24" class="ds-button-box">
                    ...
                    <Button type="ghost" size="small" @click="change_save" v-else style="background: #fff;"><Icon type="checkmark-round"></Icon></Button>
                    <Button type="ghost" size="small" v-if="ds_edit" @click="deleteType" style="background: #fff;"><Icon type="trash-a"></Icon></Button>
                    <Button type="ghost" size="small" v-else @click="close_team" style="background: #fff;"><Icon type="close-round"></Icon></Button>
        ...
        <div class="ds-table-box">
            <table class="ds-table">
                ...
                <tr>
                    <td>
                        <Row>
                            <i-col span="2">危险类别:</i-col>
                            <i-col span="22">
                                <Select v-model="dangerType" style="width:300px;" :disabled="ds_edit">
...
<script>
    ...
    export default {
        ...
        props: ['expertType', 'name', 'code', 'id', 'parentName', 'parentId', 'switchStatus', 'children', 'dangerType'],
        data () {
            return {
                treeMode: false,
                delate_info: false,
        ...
        methods: {
            ...
            alertTree() {
                let TreeInfo = {
                    ...
                    url: this.url('/platform/public/queryChemicalType4New')
                }
            ...
            change_save () {
                ...
                axios({
                    method: 'post',
                    url: this.url('/platform/chemicalType/addchemicalType'),
                    data: resTypeInfo
                }).then(
                    response => {
            ...
            delete_equipment () {
                ...
                axios({
                    method: 'get',
                    url: this.url('/platform/chemicalType/deletedChemicalType'),
