<template>
    ...
    <div class="ds-planType">
        <Row>
            ...
            <i-col span="19">
                <type-info ref="info" :queryCode="queryCode" @getTreeDatas="getTreeData" :children="children" :parentId="parentId" :name="title" :id="id" :code="code" :parentName="parentName" :valid="valid"></type-info>
            </i-col>
        </Row>
    </div>
</template>
...
<script>
    import typeInfo from './incidentTypeInfo'
    ...
    export default {
        ...
        methods: {
            ...
            clickThisTree(data) {
                ...
                this.$refs.info.getIncidentTypeDetail();
            },
            getTreeData() {
                const url = this.url + '/platform/public/queryIncidentTypeTree4New'
                const info = {
