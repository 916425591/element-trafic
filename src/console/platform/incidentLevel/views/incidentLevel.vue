...
<script>
    import typeInfo from './incidentLevelInfo'
    ...
    export default {
        ...
        methods: {
            ...
            getTreeData() {
                const url = this.url + '/platform/public/queryIncidentLevel'
                const info = {
                    ...
                    response => {
                        if (response.data.code === 200) {
                            ...
                            for (let i = 0; i < list.length; i++) {
                                ...
                                obj.code = list[i].code;
                                obj.valid = list[i].valid;
                                result[i] = obj;
                            }
                            this.typeTree = result;
                        }
                    }
                ).catch(
                    error => {
