...
<script>
    ...
    export default {
        ...
        props: ['expertType', 'name', 'code', 'id', 'parentId', 'switchStatus', 'children', 'queryCode'],
        data () {
        ...
        methods: {
            ...
            alertTree() {
                let TreeInfo = {
                    ...
                    url: this.url('/platform/public/queryIncidentLevel')
                }
                if (this.editModal) {
            ...
            change_save (name) {
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        ...
                        axios({
                            method: 'post',
                            url: this.url('/platform/incidentLevel/addIncidentLevel'),
                            data: resTypeInfo
                        }).then(
                            response => {
            ...
            delete_equipment () {
                ...
                let resourceDelete = {
                    userCode: Cookies.get('userCode'),
                    levelId: this.formItem.id
                };
                axios({
                    method: 'get',
                    url: this.url('/platform/incidentLevel/deletedIncidentLevel'),
