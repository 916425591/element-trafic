<template>
    <div class="ds-widget-box ds-box" :style='height' :data-json="tableHeight">
        ...
        <div class="ds-table-box">
            <Form ref="formCustom" :model="formItem" :rules="ruleCustom" :label-width="100">
                <FormItem label="上级类型:" >
                ...
                <FormItem label="危险类别:" prop="dangerType">
                    <Select v-model="formItem.dangerType" style="width:300px;" :disabled="ds_edit">
...
<script>
    ...
    export default {
        ...
        props: ['expertType', 'name', 'code', 'id', 'parentName', 'parentId', 'switchStatus', 'children', 'dangerType', 'queryCode'],
        data () {
            ...
            const validateDangerType = (rule, value, callback) => {
                if (value === 'null') {
                    return callback(new Error('请选择危险类型'));
                } else {
                    callback();
                }
            };
            return {
                ...
                ruleCustom: {
                    ...
                    dangerType: [
                        { required: true, validator: validateDangerType, trigger: 'change' }
                    ]
                }
            };
        },
                ...
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        let resTypeInfo = {
                            ...
                            id: this.formItem.id,
                            dangerType: this.formItem.dangerType,
