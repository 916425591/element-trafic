        ...
        methods: {
            ...
            alertTree() {
                let TreeInfo = {
                    ...
                    url: this.url('/platform/public/queryRiskType4New')
                }
                if (this.editModal) {
            ...
            change_save (name) {
                this.$refs[name].validate((valid) => {
                    if (valid) {
                        ...
                        axios({
                            method: 'post',
                            url: this.url('/platform/riskType/addRiskType'),
                            data: resTypeInfo
                        }).then(
                            response => {
            ...
            delete_equipment () {
                ...
                axios({
                    method: 'get',
                    url: this.url('/platform/riskType/deletedRiskType'),
