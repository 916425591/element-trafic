<template>
  <div>
    <Modal v-model="riskDisasterModalStatus" :mask-closable="false" width="800" @on-cancel="clickCancelBtn('accidentInfo')">
        <p slot="header" style="color:#f60;text-align:center">
            <span>可能诱发事故新增</span>
        </p>
        <div>
          <Form ref="accidentInfo" :rules="ruleCustom" :model="accidentInfo" :label-width="100">
            <Row>
              <i-col span="12">
        ...
        <br />
        <div slot="footer">
          <Table border :columns="columns1" :data="accidentDatas" highlight-row @on-row-click="risk_accident_clickTableRow" ref="accidentTable"></Table>
  ...
  data () {
      ...
      return {
          ...
          ruleCustom: {
              ...
              highRiskEnd:[
                  { validator: validateHighRiskEnd, trigger: 'blur' }
              ],
              highRiskStart:[
                  { validator: validateHighRiskStart, trigger: 'blur' }
              ],
              incidentTypeName:[
    ...
    ...mapActions([
      ...
      clickCancelBtn(name){
         ...
         const sourceType = this.accidentInfo.sourceType;
          ...
          this.accidentDatas[0]['_highlight'] = true
       ...
       * @param data
       */
      risk_accident_clickTableRow(data){
          const sourceId = this.accidentInfo.sourceId;
          const sourceType = this.accidentInfo.sourceType;
          this.accidentInfo.sourceId=sourceId;
          this.accidentInfo.sourceType=sourceType;
