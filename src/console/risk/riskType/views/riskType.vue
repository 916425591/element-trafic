<template>
    ...
    <div class="ds-planType">
        <Row>
            <i-col span="5">
                <div class="ds-widget-box" :style='height' :data-json="tableHeight">
                    ...
                    <div class="ds-search-left">
                        ...
                        <Button type="success" @click="addPlanType">新增</Button>
                    </div>
            ...
            <i-col span="19">
                <plan-type-info :children="children" :parentId="parentId" :name="title" :id="id" :code="code" :parentName="parentName" :switchStatus="switchStatus" @add-node="getTreeData"></plan-type-info>
            </i-col>
        </Row>
    </div>
</template>
...
<script>
    import planTypeInfo from './riskTypeInfo'
    ...
    export default {
        ...
        methods: {
            ...
            getTreeData() {
                const url = this.url + '/platform/public/queryRiskType4New'
                const info = {
