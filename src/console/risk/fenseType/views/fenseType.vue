<template>
    ...
    <div class="ds-planType">
        <Row>
            ...
            <i-col span="19">
                <plan-type-info :children="children" :parentId="parentId" :name="title" :id="id" :code="code" :parentName="parentName" :switchStatus="switchStatus"></plan-type-info>
            </i-col>
        </Row>
    </div>
</template>
...
<script>
    import planTypeInfo from './fenseTypeInfo'
    ...
    export default {
        ...
        methods: {
            ...
            getTreeData() {
                const url = this.url + '/platform/public/queryFenseTargetType4New'
                const info = {
